    ...
    public partial class First : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rerserva", x => x.ReservaId);
                    table.CheckConstraint("CK_Reserva_Fecha", "FechaInicio >= GETDATE()");
                    table.ForeignKey(
                        name: "FK_Rerserva_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rerserva_Vehiculo_VehiculoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rerserva_UsuarioId",
                table: "Rerserva",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_Rerserva_VehiculoId",
                table: "Rerserva",
                column: "VehiculoId");
        }
